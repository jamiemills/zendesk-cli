...
from ticketq.models.exceptions import APIError, NetworkError, RateLimitError, TimeoutError

from .models import ZendeskTicketMapper, ZendeskUserMapper, ZendeskGroupMapper
...
class ZendeskClient(BaseClient):
    ...
    def __init__(self, auth: BaseAuth) -> None:
        ...
        self._groups_cache: Optional[Dict[str, Group]] = None
